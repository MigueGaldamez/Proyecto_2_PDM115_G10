...
package com.example.habitos_saludables_g10.podometro;
...
import com.example.habitos_saludables_g10.util.API23Wrapper;
import com.example.habitos_saludables_g10.util.API26Wrapper;
import com.example.habitos_saludables_g10.util.Logger;
import com.example.habitos_saludables_g10.util.Util;
import com.example.habitos_saludables_g10.widget.WidgetUpdateService;
    ...
    public static Notification getNotification(final Context context) {
        ...
        notificationBuilder.setPriority(Notification.PRIORITY_MIN).setShowWhen(false)
                ...
                PendingIntent.getActivity(context, 0, new Intent(context, Activity_Main.class),
                        PendingIntent.FLAG_UPDATE_CURRENT)).setSmallIcon(R.mipmap.ic_notification)
                .setOngoing(true);
